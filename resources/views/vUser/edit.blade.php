<div class="p2">
    ...
    <div class="form-group">
        <input type="email" name="email" id="email" class="form-control" placeholder="Email" value="{{ $edit->email }}">                   
    </div>
    
    <div class="form-group">
        <input type="text" name="jabatan" id="jabatan" class="form-control" placeholder="Jabatan" value="{{ $edit->jabatan }}">                   
    </div>
    ...
    <div class="form-group">
        <button class="btn btn-success btn-sm pull-left" onclick="update({{ $edit->id }})">Update</button>
    </div>  
</div>
